<template>
    ...
    <Supplier v-for="supplier in suppliers" :key="supplier.id" :name="supplier.name" :status="supplier.status" :checked-at="supplier.checkedAt" :latitude="supplier.latitude"  class="cadre"/> 
